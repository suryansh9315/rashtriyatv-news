...
const authors = () => {
  return (
    ...
    <div className={poppins.className}>लेखक की कलम से</div>
  </div>
  <Swiper
        slidesPerView={1}
        spaceBetween={30}
      ...
      >
        <SwiperSlide>
          <iframe
            ...
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-authors; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        </SwiperSlide>
        <SwiperSlide>
