    ...
    <div className="bg-[#fff] shadow rounded-xl p-10 flex justify-center gap-14 lg:gap-28 flex-wrap">
      ...
      <div className="w-[300px] flex flex-col gap-5">
        ...
        <div className="flex items-center gap-5">
          <a
            href="https://www.facebook.com/RashtriyaTv?mibextid=ZbWKwL"
            target="_blank"
          ...
          <a
            href="https://twitter.com/i/flow/login?redirect_after_login=%2Frashtriyatv"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div
          ...
          <a
            href="https://www.instagram.com/rashtriyatv2021/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div
          ...
          <a
            href="https://www.youtube.com/@rashtriyatv5956"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div
