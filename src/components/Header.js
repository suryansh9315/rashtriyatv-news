    ...
    <header className=" text-gray-600 body-font">
      <div className="container mx-auto">
        <div className="grid grid-cols-2 ">
          <div className="col-span-1 bg-white-200 p-2">
            <div className=" mx-auto container flex flexWrap p-3 flex-col md:flex-row items-center">
              ...
              <Link
                href="/"
                className="flex link link-underline link-underline-black title-font font-medium items-center textWh mb-2 md:mb-0 ml-4 text-4xl text-black"
              >
                RASHTRIYA TV
                <br/>
                राष्ट्रीय टीवी
          ...
          <div className="col-span-1 bg-white-200 p-0 flex items-center justify-end pr-12">
            <form>
                <div className="relative w-full scale-x-110">
                  <input
                    type="search"
                    id="search-dropdown"
